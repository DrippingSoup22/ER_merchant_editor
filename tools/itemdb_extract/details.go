...
// straight to internal/assets/data/item_details.json (not stdout, so the existing
// `go run . > ../../internal/assets/data/items.json` regenerate command is untouched and
...
// loadSpellStats reads internal/assets/data/spell_stats.json (generated by
...
func loadSpellStats() map[uint32]*spellDetail {
	raw, err := os.ReadFile("../../internal/assets/data/spell_stats.json")
	if err != nil {
...
// loadConsumableScaling reads internal/assets/data/consumable_scaling.json (generated by
...
func loadConsumableScaling() map[uint32]*scalingDetail {
	raw, err := os.ReadFile("../../internal/assets/data/consumable_scaling.json")
	if err != nil {
...
func writeItemDetails(items []db.ItemEntry) error {
	...
	return os.WriteFile("../../internal/assets/data/item_details.json", append(raw, '\n'), 0o644)
}
