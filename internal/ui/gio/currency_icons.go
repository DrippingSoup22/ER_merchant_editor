...
// (2026-07-29): the vendored source icons (internal/assets/icons/items, same embedded FS
...
import (
	...
	iconassets "github.com/DrippingSoup22/ER_merchant_editor/internal/assets/icons"
)
...
func decodeCroppedCurrencyIcon(iconPath string) paint.ImageOp {
	raw, err := iconassets.FS.ReadFile(iconPath)
	if err != nil {
