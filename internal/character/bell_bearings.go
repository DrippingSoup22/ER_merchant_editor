...
// adapted external data as internal/character/flags's exception/BST tables, covered
...
// internal/assets/data/merchant_catalog.json's canonical merchant names. Of the 18
...
type BellBearing struct {
	...
	Merchant string // canonical internal/assets/data/merchant_catalog.json name, "" if not confidently mappable
