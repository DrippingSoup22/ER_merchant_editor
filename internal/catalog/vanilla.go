...
// (internal/assets/data/vanilla_shop_lineup.json, generated once from save_files/
...
// see internal/ui/gio/staging.go's rowEditFromVanillaDiff for why: the
...
// material-locked (mirrors internal/ui/gio/staging.go's applyDrop, which
