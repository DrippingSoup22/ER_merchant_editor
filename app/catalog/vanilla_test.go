...
// data/vanilla_shop_lineup.json was generated from, so diffing it against
...
// fixture, flatten to shopwrite.Edit the same way the GUI's
...
func TestResetToVanillaRoundTrip(t *testing.T) {
	...
	edits := make([]shopwrite.Edit, 0, len(diffs))
