...
// pendingModalScrim matches widgets.Modal's own scrim color -- same "dim
...
// beyond what the shared widgets.Modal (title/body/OK) supports.
...
func (s *State) layoutPendingOverlay(gtx layout.Context, th *material.Theme) {
	...
	widgets.Backdrop(gtx,
		...
		// Same scrim alpha, 1dp border and 16dp inset as widgets.Modal, but a
