...
func (s *State) applyTheme() {
	...
	widgets.SetPalette(s.Settings.Theme)
	if s.th == nil {
...
// Both paint via op.Defer (widgets.Backdrop) so they composite above the whole
...
// cellSize is the caller's actual rendered cell width (widgets.IconCellSize
